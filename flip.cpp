...
// Last Modified  Tue Apr  9 12:24:27 PST 2002 Added Mac conversion.
// Last Modified  Mon Jan 20 21:12:52 PST 2003 Conversion from mac to others.
...
// Last Modified  Sun Oct 12 13:17:59 PDT 2014 Removed static compiling flag.
// Web Address:   https://github.com/craigsapp/flip
// Syntax:        C++ 
// $Smake:        g++ -ansi -O3 -o %b %f && strip %b
...
void exitUsage(const char* commandName) {
   cout << "\nUsage: " << commandName << " [-t|-u|-d|-m] filename[s]\n"
        << "   Converts ASCII files between Unix, MS-DOS/Windows,\n"
        << "   or Macintosh newline formats\n\n"
        << "   Options: \n"
        << "      -u  =  convert file(s) to Unix newline format (newline)\n"
        << "      -d  =  convert file(s) to MS-DOS/Windows newline format\n"
	<< "             (linefeed + newline)\n"
        << "      -m  =  convert file(s) to Macintosh newline format "
        << 							"(linefeed)\n"
